...
namespace easyPC.Controllers
{
    public class ComponentesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Tipo,Marca,Modelo")] Componente componente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Tipo,Marca,Modelo")] Componente componente)
        {
            if (id != componente.Id)
            {
                return NotFound();
